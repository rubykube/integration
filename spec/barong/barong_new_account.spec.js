context('Barong', () => {
    ...
    describe('Creation new account', () => {
        ...
        it('fill account data', () => {
            cy.get('@user').then((user) => {
                cy.visit('http://auth.wb1.helioscloud.com/accounts/sign_up')
    ...
    describe('2 lvl', () => {
        ...
        it('confirm phone in admin panel', () => {
            cy.get('@user').then((user) => {
                ...
                cy.visit('http://auth.wb1.helioscloud.com/accounts/sign_in')
                cy.login()
                cy.visit('http://auth.wb1.helioscloud.com/admin')
    ...
    describe('3 lvl', () => {
        it('fill personal information', () => {
            cy.clearCookie('_barong_session')
            loginUser()
            cy.visit('http://auth.wb1.helioscloud.com/profiles/new')
